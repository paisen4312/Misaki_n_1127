...
def hasListUser():
    ...
    for user in participants.dict.keys():
        ...
        with open(properties.csv_path + participants.dict[user] +'.csv', 'w',newline='',encoding='utf-8') as f:
            ...
            print('<tr><td bgcolor="#FFFFFF" align="left" nowrap width="250">')
            print(participants.dict[user])            
            print('<td bgcolor="#FFFFFF" valign="top" width="250"></td>')
            print('<td bgcolor="#FFFFFF" valign="top" width="250">')
            print(RT_count * 30)
            print('</td></tr>')
